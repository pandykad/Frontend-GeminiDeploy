...
function renderBrand() {
  return jsxs("a", { className: "mm-toolbar-brand", href: "https://markmap.js.org/", children: [
    jsx(
      "img",
      {
        alt: "markmap",
    ...
    jsx("span", { children: "markmap" })
  ] });
}
function renderItem({ title, content, onClick }) {
  return jsx("div", { className: clsToolbarItem, title, onClick, children: content });
}
var promise;
...
var _Toolbar = class _Toolbar2 {
  constructor() {
    this.showBrand = true;
    this.registry = {};
    this.el = mountDom(jsx("div", { className: "mm-toolbar" }));
  ...
  static icon(path, attrs = {}) {
    ...
    return jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", children: jsx("path", { ...attrs, d: path }) });
  }
  setBrand(show) {
    this.showBrand = show;
    return this.render();
...
*/
//# sourceMappingURL=markmap-toolbar.js.map
